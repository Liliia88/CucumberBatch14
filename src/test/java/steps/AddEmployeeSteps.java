...
public class AddEmployeeSteps extends CommonMethods {
    ...
    public void user_enter_firstname_and_lastname() {
        ...
        // firstName.sendKeys("Liliia");
        sendText(addEmployee.firstNameField, "Liliia");
        sendText(addEmployee.lastNameField, "Khusainova");
        //WebElement lastName = driver.findElement(By.id("lastName"));
        //lastName.sendKeys("Khusainova");
    }
    ...
    public void user_adds_multiple_employees_and_verify_they_are_added_successfully(DataTable dataTable) throws InterruptedException {
        ...
        for (Map<String, String> employee : employeeNames) {
            ...
            if (employeeList.personalDetails.isDisplayed()) {
                System.out.println("Employee is displayed and added into the list successfully");
            } else {
                System.out.println("Employee is not displayed and not added yet");
            }
...
*/
            /*
            WebElement firstNameCheck = driver.findElement(By.id("personal_txtEmpFirstName"));
            String expectedResult = mapNewEmp.get("firstName");
            String actualResult = firstNameCheck.getAttribute("value");
            Assert.assertEquals ( expectedResult, actualResult );
*/


//add employee and verify it. hw
//verification is in hw
